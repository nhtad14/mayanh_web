<?php
        if(isset($_POST['submit'])){
            ...
            $sql = "INSERT INTO sanpham(idsp, tensp, image, price, information) VALUES ('$idsp','$tensp','$image','$price','$information')";
            mysqli_query($conn,$sql) or die("Thêm du lieu that bai.");
                                    ...
                                    <div class="col-lg-6">
                                        <form method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input style="width: 100px;" ;type="text" name="price"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <button name="submit" class="btn btn-success" type="submit">Thêm sản
                                                phẩm</button>
                                        </form>
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
