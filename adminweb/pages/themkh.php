...
<body>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="updatekh.php">Thêm Khách hàng </a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <form method="POST">
                                            ...
                                            <button type="submit" name="smb" class="btn btn-success"> Thêm khách
                                                hàng</button>
                                        </form>
                                    </div>
                                    <!-- /.col-lg-6 (nested) -->
    ...
    <?php
        ...
        if(isset($_POST['smb'])){
            ...
            $sql = "INSERT INTO khachhang VALUES (null,'$tenkh','$tk','$password','$phone', '$address')";
