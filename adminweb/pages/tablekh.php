                                         ...
                                         while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            $address = $row['address'];
                                             echo"<tr class='odd gradeX'>";
                                                 ...
                                                 echo"<td>$phone</td>";
                                                 echo"<td>$address</td>";
                                                 echo"<td> <a href ='updatekh.php?idkh=$idkh'> <button name='update' value ='update' class ='btn btn-success' type='button'>Sửa</button></a> 
                                                    <a  href='deletekh.php?idkh=$idkh'><button name='button'class ='btn btn-success' type='button'>Xóa</button>
                                                 </td>";
                                             echo"</tr> ";
                                             echo"</tbody>";
                                         }
