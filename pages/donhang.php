            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-wrench fa-fw"></i>Quản lí đơn hàng <span
                                    class="fa arrow"></span></a>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                                         ...
                                         while($row = mysqli_fetch_assoc($result)){
                                            ...
                                            $tinhtrang =$row['tinhtrang'];
                                             echo"<tr class='odd gradeX'>";
                                                 ...
                                                 echo"<td><a href ='chitiet.php?&id= $id'> <button name='button' class ='btn btn-success' type='button'>Xem</button></a></tf>";
                                                 echo"<td class='center'> <a href ='updatedonhang.php?&id=$id'> <button name='button' class ='btn btn-success' type='button'>Sửa</button></a> 
                                                 </td>";
                                             echo"</tr> ";
                                             echo"</tbody>";
                                         }
